...
const REQUIRED = new Set([
  ...
  "privacy_entity",
  "recording_entity",
  "movement_angle_entity",
  "motion_detection_entity",
  "person_detection_entity",
  "pet_detection_entity",
  "vehicle_detection_entity",
  "tamper_detection_entity",
  "cry_detection_entity",
  "bark_detection_entity",
  "meow_detection_entity",

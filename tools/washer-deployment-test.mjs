...
assert.match(
  resource,
  /^url:\s+https:\/\/cdn\.jsdelivr\.net\/gh\/jaeryun\/ha-design@c5cc83ebe40a3d66288f1cb80abd2bc9af1a457b\/www\/ha-design\/ha-design-washer-card\.js\?v=washer-warm-utility-20260830-1$/m,
);

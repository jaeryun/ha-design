...
assert.match(
  resource,
  /^url:\s+https:\/\/cdn\.jsdelivr\.net\/gh\/jaeryun\/ha-design@5d1933a040292e885e2c687a5e49ff002e82d914\/www\/ha-design\/ha-design-camera-card\.js\?v=camera-local-20260902-15$/m,
);
...
assert.match(card, /ha-design-camera-event-controller\.js\?v=camera-ios-hls-20260902-2/);
assert.match(eventController, /ha-design-camera-event-state\.js\?v=camera-ios-hls-20260902-1/);

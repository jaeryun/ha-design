...
assert.match(
  resource,
  /^url:\s+https:\/\/cdn\.jsdelivr\.net\/gh\/jaeryun\/ha-design@79f8e939c74073dfda25b2f77dae853ab4aa4fdf\/www\/ha-design\/ha-design-camera-card\.js\?v=camera-time-history-20260906-1$/m,
);
